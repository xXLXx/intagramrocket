		...
		<div id="EWD_URP_pro" class="postbox " >
			...
			<h3 class='hndle'><span><?php _e("Thank You!", 'ultimate-reviews') ?></span></h3>
		 	<div class="inside">
				...
				<?php } else { ?><ul><li><?php _e("Thanks for upgrading to version 1.2.7!", 'ultimate-reviews'); ?><br> <a href='https://wordpress.org/support/view/plugin-reviews/ultimate-reviews?filter=5'><?php _e("Please rate our plugin", 'ultimate-reviews'); ?></a> <?php _e("if you find Ultimate Reviews useful!", 'ultimate-reviews');?> </li></ul><?php } ?>
