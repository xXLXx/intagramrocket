...
function URP_Return_Pointers() {
  ...
  $pointers['tutorial-one'] = array(
    ...
    'content'   => "<div><p>Thanks for installing Ultimate Reviews! These 6 slides will help get you started using the plugin.</p></div><div class='urp-pointer-count'><p>1 of 6</p></div>",
    'anchor_id' => '.Header',
    'edge'      => 'top',
    'align'     => 'left',
    'width'     => '320',
  ...
  $pointers['tutorial-three'] = array(
    ...
    'content'   => "<div><p>Place the [ultimate-reviews] shortcode in the content area of any page you've created and it will display your reviews. Use the 'product_name' attribute to limit the displayed reviews to one product.</p></div><div class='urp-pointer-count'><p>3 of 6</p></div>",
    'anchor_id' => '#menu-pages',
    'edge'      => 'top',
    'align'     => 'left',
    'width'     => '320',
  ...
  $pointers['tutorial-four'] = array(
    ...
    'content'   => "<div><p>Click 'Add New' to manually create reviews for your visitors to view. Enter the review title in the title area and the review content in the main post content area. If you'd like, you can set a review image using the 'Featured Image' area. Set the review details (product name, score, author, etc.) using the 'Review Details' section under the main post content area.</p></div><div class='urp-pointer-count'><p>4 of 6</p></div>",
