...
function gstestimonial_help_menu_cb() {
    ...
    <div class="wrap">
    	...
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 50px; text-align: center;">
			...
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsamdani.com/product/gs-testimonial-slider" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://www.testimonial.gsamdani.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://www.testimonial.gsamdani.com/documentation" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://www.testimonial.gsamdani.com/documentation/#GS_Testimonial_Slider8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
