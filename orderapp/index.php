        ...
        while ($row=mysqli_fetch_row($result))
          {
              ...
              $fields = array($inv_date,$order_id,'Draft',$customer_name,$due_date,$po_order,'Classic',$Currency,'',$item_name,'',$quantity,$price,'TRUE','','','','','','','','Thanks for your business.','Terms and Condition','','false','false',$billing_address);
