...
*/
	 ...
	 else if(isset($_GET['gateshop']) && isset($_GET['amount']))
	{
		    ...
		    $params = array('currency' =>'USD',
		                ...
		                'version' => "3.0.0",
		                'success_url' => 'https://instagramrocket.com/devsite/follower?getdone=1',
	...
	else if(isset($_GET['stripedone']) && isset($_GET['subscription']) && isset($_GET['username']) && isset($_GET['random']))
	{
		...
		//die;
			...
			if($_GET['random'])
			{
					...
					<h3 style="text-align: center;">Please wait, this may take a few seconds.</h3>
						...
						<div class="wpb_single_image wpb_content_element vc_align_center">
							...
							<figure class="wpb_wrapper vc_figure">
								<div style="text-align:center"  class="vc_single_image-wrapper   vc_box_border_grey"><img width="225" height="187" src="https://www.instagramrocket.com/devsite/wp-content/uploads/2017/06/processing.gif" class="vc_single_image-img attachment-full" alt=""></div>
							</figure>
						</div>
					</div>
				...
				header("Location: https://www.instagramrocket.com/devsite/success-page/");
				die();
			...
			$wrap = new CS_REST_Transactional_SmartEmail($smart_email_id, $auth);
				...
				else if($process=='likes')
				{
					...
					exit;*/
						...
						$split = count($code_Array);

						foreach ($code_Array as $_code) {
							
							$url = 'https://www.instagram.com/p/'.$_code.'/';
							
							$params = array('service' => $service->service_id, 'link' =>$url, 'quantity' => $likeperpage);
