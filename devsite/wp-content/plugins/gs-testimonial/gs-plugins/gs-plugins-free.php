...
if( ! class_exists( 'GSPlugins_testimonial_free' ) ){
    
    class GSPlugins_testimonial_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPlugins_testimonial_free ) {
                self::$_instance = new GSPlugins_testimonial_free();
            }
        ...
        public function gs_plugins_free_menu() {
            ...
            add_submenu_page( 
                ...
                'manage_options', 
                'gs-plugins-free', 
                array( $this, 'gstesti_free_menu_cb' )
                );
        }
        
        public function gstesti_free_menu_cb() { ?>	  
    ...
    $gsplugin_free = GSPlugins_testimonial_free::get_instance();
}