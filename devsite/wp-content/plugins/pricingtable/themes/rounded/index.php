...
function pricingtable_body_rounded($post_id)
	{
		...
		while($j<=$pricingtable_total_column)
			...
			$pricingtable_body.=  '<div  style="width:'.$column_width.'px;height:'.$column_width.'px; background-color:'.$pricingtable_cell_signup_bg_color[$j].'"  class="pricingtable-columns" >';
			$pricingtable_body.=  '<div  class="pricingtable-items-container" style="height:'.$column_width.'px;">';
