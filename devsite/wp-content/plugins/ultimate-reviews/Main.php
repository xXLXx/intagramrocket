...
function EWD_URP_Enable_Sub_Menu() {
	...
	add_menu_page( 'Ultimate Reviews', 'Reviews', 'edit_posts', 'EWD-URP-Options', 'EWD_URP_Output_Options', null, '49.1' );
	...
	add_submenu_page('EWD-URP-Options', 'URP Options', 'Settings', 'edit_posts', 'EWD-URP-Options&DisplayPage=Options', 'EWD_URP_Output_Options');
...
if (get_option("URP_Run_Tutorial") == "Yes" and $_GET['page'] == 'EWD-URP-Options') {
