...
function EWD_URP_Add_Default_Field($Review_Category_Item, $product_name, $Logged_In_User) {
	...
	elseif ($Review_Category_Item['CategoryName'] == "Review Title") {$ReturnString .= EWD_URP_Add_Review_Title_Field();}
...
function EWD_URP_Add_Author_Email_Field() {
	...
	$ReturnString .= __("Reviewer's Email Address", 'ultimate-reviews') . ": </label>";
	$ReturnString .= "<input type='email' name='Post_Email' id='Post_Email' value='" . $_REQUEST['Post_Email'] . "' required/>";
	$ReturnString .= "<div id='ewd-urp-author-explanation' class='ewd-urp-review-explanation'>";
	$ReturnString .= "<label for='explanation'></label><span>" . __('Please confirm your e-mail to verify your identity. It will not be displayed.', 'ultimate-reviews')  . "</span>";
	$ReturnString .= "</div>";
	$ReturnString .= "</div>";
...
function EWD_URP_Add_Review_Title_Field() {
	...
	$ReturnString .= "<input type='text' name='Post_Title' id='Post_Title' value='" . $_POST['Post_Title'] . "' required/>";
...
function EWD_URP_Add_Custom_Field($Review_Category_Item) {
	...
	elseif ($Review_Category_Item['CategoryType'] == "Dropdown") {
		...
		if (!empty($Options)) {
			$ReturnString .= "<select name='" . $Review_Category_Item['CategoryName'] . "'>";
			...
			$ReturnString .= "<div class='ewd-urp-submit-review-radio-checkbox-container'>";
				...
				foreach ($Options as $Option) {
					$ReturnString .= "<div class='ewd-urp-submit-review-radio-checkbox-each'>";
						$ReturnString .= "<input type='checkbox' name='" . $Review_Category_Item['CategoryName'] . "[]' value='" . $Option . "' />" . $Option;
	...
	elseif ($Review_Category_Item['CategoryType'] == "Radio") {
		...
		if (!empty($Options)) {
			$ReturnString .= "<div class='ewd-urp-submit-review-radio-checkbox-container'>";
				foreach ($Options as $Option) {
					$ReturnString .= "<div class='ewd-urp-submit-review-radio-checkbox-each'>";
						$ReturnString .= "<input type='radio' name='" . $Review_Category_Item['CategoryName'] . "' value='" . $Option . "' />" . $Option;
					$ReturnString .= "</div>"; //ewd-urp-submit-review-radio-checkbox-each
				}
			$ReturnString .= "</div>"; //ewd-urp-submit-review-radio-checkbox-container
		}
	}
	elseif ($Review_Category_Item['CategoryType'] == "Date") {$ReturnString .= "<input type='date' id='ewd-urp-" . $Review_Category_Item['CategoryName'] . "' name='" . $Review_Category_Item['CategoryName'] . "' />";}
	elseif ($Review_Category_Item['CategoryType'] == "DateTime") {$ReturnString .= "<input type='datetime-local' id='ewd-urp-" . $Review_Category_Item['CategoryName'] . "' name='" . $Review_Category_Item['CategoryName'] . "' />";}
	$ReturnString .= "</div>";
