...
* Add in custom fields to the review that don't affect the score/rating, such as text, checkbox, radio button and drop-down fields for your product reviews
* Multiple rating systems, including points and percentage
* Set the maximum score and use either a text input, dropdown selection or number of stars for product review score input
...
<strong>With WooCommerce Integration!</strong> See the "WooCommerce Integration" section below for full details and features.
...
Have any reviews questions? Please check out the product reviews support forum.
